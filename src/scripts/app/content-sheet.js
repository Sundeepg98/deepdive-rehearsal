...
.cs-num{font-size:var(--font-size-caption);line-height:1.55;margin-bottom:var(--space-6);color:var(--ink)}
.cs-ha{font-size:var(--font-size-caption);line-height:1.55;margin-bottom:var(--space-7);color:var(--ink)}
...
.cs-bad{text-align:right;color:var(--red);font-size:var(--font-size-caption);line-height:1.4}
.cs-arr2{color:var(--mut2);font-weight:var(--font-weight-heavy)}
.cs-fix{text-align:left;color:var(--teal);font-weight:var(--font-weight-semibold);font-size:var(--font-size-caption);line-height:1.4}
.cs-tells{margin:0;padding-left:var(--space-20)}
.cs-tells li{font-size:var(--font-size-caption);line-height:1.55;margin-bottom:var(--space-6);color:var(--ink)}
.cs-30{background:linear-gradient(135deg,var(--cs30-bg) 0%,rgba(83,74,183,.02) 100%);border:1px solid var(--bd);border-radius:11px;padding:var(--space-13) var(--space-15);font-size:var(--font-size-caption);line-height:1.58;color:var(--ink)}
