...
(function () {
  ...
  var COPY_STYLE = 'position:absolute;top:var(--space-6);right:var(--space-6);font-size:var(--font-size-nano);font-weight:var(--font-weight-semibold);letter-spacing:.5px;text-transform:uppercase;padding:var(--space-4) var(--space-10);border-radius:6px;border:1px solid var(--bd);background:var(--card);color:var(--mut);cursor:pointer;opacity:0;transition:opacity var(--duration-base) var(--ease-base),background var(--duration-base) var(--ease-base);z-index:5';
