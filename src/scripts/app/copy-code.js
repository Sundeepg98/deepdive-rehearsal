...
(function () {
  ...
  var COPY_STYLE = 'position:absolute;top:var(--space-6);right:var(--space-6);font-size:var(--font-size-nano);font-weight:650;letter-spacing:.5px;text-transform:uppercase;padding:var(--space-4) var(--space-10);border-radius:6px;border:1px solid var(--bd);background:var(--card);color:var(--mut);cursor:pointer;opacity:0;transition:opacity .2s ease,background .2s ease;z-index:5';
