...
.mb-tag{display:inline-block;margin-left:var(--space-9);font-size:10px;font-weight:800;letter-spacing:.6px;color:var(--acc);background:var(--accbg);border-radius:5px;padding:var(--space-2) var(--space-9);vertical-align:middle}
.mb-cue{font-size:16.5px;font-weight:700;color:var(--ink);line-height:1.42;margin:var(--space-13) 0 0}
.mb-task{font-size:13px;color:var(--mut);line-height:1.55;margin:var(--space-10) 0 0;font-style:italic}
.mb-task b{color:var(--accink);font-style:normal}
.mb-model{display:none;margin:var(--space-16) 0 0;padding:var(--space-15) var(--space-17);background:linear-gradient(135deg,var(--accbg) 0%,rgba(83,74,183,.04) 100%);border-radius:12px;font-size:13.5px;color:var(--ink);line-height:1.62;box-shadow:0 1px 6px -2px rgba(83,74,183,.1)}
...
.mb-keys{margin-top:var(--space-13);font-size:10.5px;color:var(--mut2);text-align:center;letter-spacing:.2px}
.mb-rev,.mb-next{font:700 12.5px -apple-system,sans-serif;padding:var(--space-9) var(--space-16);border-radius:9px;cursor:pointer;transition:transform .15s ease,box-shadow .2s ease,border-color .2s ease,background .2s ease}
...
.mb-end-t{font-size:13.5px;color:var(--mut);margin:var(--space-9) auto 0;max-width:var(--space-420);line-height:1.56}
.mb-end-time{font-weight:800;color:var(--acc);font-family:ui-monospace,Menlo,monospace}
.mb-score-q{font-size:13px;color:var(--ink);font-weight:600;margin:var(--space-19) 0 var(--space-11)}
.mb-score{display:flex;gap:var(--space-6);justify-content:center;flex-wrap:wrap}
.mb-score button{width:var(--space-40);height:var(--space-40);border-radius:10px;border:1.5px solid var(--bd);background:linear-gradient(135deg,var(--card) 0%,rgba(83,74,183,.02) 100%);color:var(--ink);font:800 14px ui-monospace,monospace;cursor:pointer;transition:transform .15s ease,border-color .2s ease,box-shadow .2s ease,color .2s ease}
...
.mb-verdict{display:none;margin:var(--space-15) auto 0;max-width:var(--space-430);padding:var(--space-14) var(--space-17);border-radius:11px;font-size:13px;line-height:1.55;box-shadow:0 1px 6px -2px rgba(83,74,183,.08)}
...
.mb-again button{font:700 12px -apple-system,sans-serif;padding:var(--space-9) var(--space-17);border-radius:9px;cursor:pointer;border:1.5px solid var(--bd);background:linear-gradient(135deg,var(--card) 0%,rgba(83,74,183,.02) 100%);color:var(--mut);transition:transform .15s ease,border-color .2s ease,box-shadow .2s ease,color .2s ease}
...
.mb-end-int{margin-top:var(--space-12);font-size:12px;line-height:1.5;color:var(--amber);background:linear-gradient(135deg,var(--amberbg) 0%,rgba(176,108,20,.04) 100%);border:1px solid #e6c89a;border-radius:10px;padding:var(--space-10) var(--space-14)}
.mb-end-cv{margin-top:var(--space-12);font-size:12px;line-height:1.5;color:var(--accink);background:linear-gradient(135deg,var(--accbg) 0%,rgba(83,74,183,.04) 100%);border:1px solid var(--mb-cv-bd);border-radius:10px;padding:var(--space-10) var(--space-14)}
...
.mb-irev{margin-top:var(--space-12);border:1.5px solid var(--mb-irev-bd);background:linear-gradient(135deg,var(--mb-irev-bg) 0%,rgba(239,68,68,.04) 100%);color:var(--red);font:700 11.5px -apple-system,sans-serif;padding:var(--space-8) var(--space-14);border-radius:9px;cursor:pointer;transition:transform .12s ease,background .15s ease,color .15s ease,border-color .15s ease}
...
.mb-int-a{display:none;margin-top:var(--space-12);padding-top:var(--space-12);border-top:1px dashed #e3bdb8;font-size:13px;color:var(--ink);line-height:1.6}
