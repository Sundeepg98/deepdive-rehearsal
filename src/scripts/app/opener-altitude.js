...
var OP_STYLE = `
.op-lead{font-size:var(--font-size-body);max-width:var(--measure);line-height:var(--line-height-loose);color:var(--ink);margin:var(--space-2) 0 var(--space-18)}
...
.op-ht{font-size:var(--font-size-body);max-width:var(--measure);color:var(--ink);line-height:var(--line-height-loose);padding-top:var(--space-3)}
.op-ht b{color:var(--accink);font-weight:var(--font-weight-bold)}
.op-ht i{color:var(--mut);font-style:italic}
.op-a{display:none;margin:var(--space-12) 0 0 var(--space-39);padding:var(--space-14) var(--space-17);background:linear-gradient(135deg,var(--accbg) 0%,var(--acc-a04) 100%);border-radius:10px;font-size:var(--font-size-body);max-width:var(--measure);color:var(--ink);line-height:var(--line-height-spacious);box-shadow:0 1px 6px -2px var(--acc-a08)}
...
.op-rev{margin:var(--space-12) 0 0 var(--space-39);font:var(--font-weight-bold) 11.5px var(--sans);padding:var(--space-7) var(--space-15);border-radius:8px;border:1.5px solid #cfc7f0;background:linear-gradient(135deg,var(--accbg) 0%,var(--acc-a04) 100%);color:var(--accink);cursor:pointer;transition:transform var(--duration-fast) var(--ease-base),background var(--duration-fast) var(--ease-base),border-color var(--duration-fast) var(--ease-base),box-shadow var(--duration-base) var(--ease-base)}
...
.op-hk-t{font-size:var(--font-size-body);max-width:var(--measure);color:var(--mut);line-height:var(--line-height-airy);margin-bottom:var(--space-8)}
...
.op-q{font-size:var(--font-size-body);max-width:var(--measure);color:var(--teal);font-weight:var(--font-weight-bold);font-style:italic}
.op-d{font-size:var(--font-size-body);max-width:var(--measure);color:var(--ink);line-height:var(--line-height-airy);margin-top:var(--space-4)}
...
.op-foot{margin-top:var(--space-18);font-size:var(--font-size-body);max-width:var(--measure);color:var(--op-foot-fg);background:linear-gradient(135deg,var(--op-foot-bg) 0%,var(--acc-a03) 100%);border-left:3px solid var(--acc);border-radius:9px;padding:var(--space-14) var(--space-17);line-height:var(--line-height-spacious)}
