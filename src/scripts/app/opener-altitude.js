...
.op-n{flex:none;width:var(--space-27);height:var(--space-27);border-radius:50%;background:linear-gradient(135deg,var(--accbg) 0%,rgba(83,74,183,.06) 100%);border:1.5px solid var(--acc);color:var(--accink);font:var(--font-weight-heavy) 12px ui-monospace,monospace;display:flex;align-items:center;justify-content:center;box-shadow:0 2px 6px -2px rgba(83,74,183,.15)}
...
.op-a{display:none;margin:var(--space-12) 0 0 var(--space-39);padding:var(--space-14) var(--space-17);background:linear-gradient(135deg,var(--accbg) 0%,rgba(83,74,183,.04) 100%);border-radius:10px;font-size:var(--font-size-small);color:var(--ink);line-height:var(--line-height-spacious);box-shadow:0 1px 6px -2px rgba(83,74,183,.08)}
...
.op-rev{margin:var(--space-12) 0 0 var(--space-39);font:var(--font-weight-bold) 11.5px -apple-system,sans-serif;padding:var(--space-7) var(--space-15);border-radius:8px;border:1.5px solid #cfc7f0;background:linear-gradient(135deg,var(--accbg) 0%,rgba(83,74,183,.04) 100%);color:var(--accink);cursor:pointer;transition:transform var(--duration-fast) var(--ease-base),background var(--duration-fast) var(--ease-base),border-color var(--duration-fast) var(--ease-base),box-shadow var(--duration-base) var(--ease-base)}
...
.op-tab{display:inline-block;margin-left:var(--space-6);font-size:var(--font-size-micro);font-weight:var(--font-weight-bold);color:var(--acc);background:linear-gradient(135deg,var(--accbg) 0%,rgba(83,74,183,.04) 100%);border-radius:5px;padding:var(--space-2) var(--space-8);white-space:nowrap;border:1px solid #cfc7f0}
.op-foot{margin-top:var(--space-18);font-size:var(--font-size-caption);color:var(--op-foot-fg);background:linear-gradient(135deg,var(--op-foot-bg) 0%,rgba(83,74,183,.03) 100%);border-left:3px solid var(--acc);border-radius:9px;padding:var(--space-14) var(--space-17);line-height:var(--line-height-spacious)}
