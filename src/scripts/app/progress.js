...
var Progress = (function () {
  ...
  function summary() {
    ...
    var totDone = 0, totTot = 0, totWeak = 0, touched = 0;
    ...
    return { topics: topics, byGroup: byGroup, weakest: weakest, totDone: totDone, totTot: totTot, totWeak: totWeak, touched: touched, nTopics: ids.length };
  }
