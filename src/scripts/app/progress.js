...
var Progress = (function () {
  ...
  return { snapshot: snapshot, get: get, all: all, clear: clear, clearAll: clearAll, status: status, summary: summary, markShaky: markShaky, shakyMarks: shakyMarks, wbGet: wbGet, wbSteps: wbSteps, weakIdx: weakIdx, snapshotWb: snapshotWb };
})();
