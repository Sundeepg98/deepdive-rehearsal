...
.rf-x{flex:none;color:var(--red);font:var(--font-weight-heavy) 14px -apple-system,sans-serif;line-height:1.55;width:var(--space-24);height:var(--space-24);border-radius:50%;background:linear-gradient(135deg,var(--redbg) 0%,rgba(239,68,68,.1) 100%);display:flex;align-items:center;justify-content:center;border:1.5px solid var(--red)}
...
.rf-tell{font-size:var(--font-size-caption);color:var(--mut);line-height:1.55;margin:var(--space-9) 0 var(--space-11);padding-left:var(--space-24)}
...
.rf-fix{display:flex;gap:var(--space-10);align-items:flex-start;font-size:var(--font-size-small);line-height:1.55;padding-top:var(--space-11);border-top:1px dashed var(--bd)}
.rf-c{flex:none;color:var(--teal);font-weight:var(--font-weight-heavy);line-height:1.5;font-size:var(--font-size-body)}
