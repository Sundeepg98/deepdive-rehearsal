...
/* ============ RED FLAGS (web component) ============
   ...
   extra tokens. */
var RF_STYLE = `
.rflead{font-size:var(--font-size-body);line-height:var(--line-height-loose);color:var(--ink);margin:var(--space-2) var(--space-2) var(--space-18)}
...
.rf-tell{font-size:var(--font-size-caption);color:var(--mut);line-height:var(--line-height-airy);margin:var(--space-9) 0 var(--space-11);padding-left:var(--space-24)}
...
.rf-fix{display:flex;gap:var(--space-10);align-items:flex-start;font-size:var(--font-size-small);line-height:var(--line-height-airy);padding-top:var(--space-11);border-top:1px dashed var(--bd)}
