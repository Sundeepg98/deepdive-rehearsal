...
.cmp-err{font-size:var(--font-size-caption);color:var(--red);background:linear-gradient(135deg,var(--redbg) 0%,rgba(239,68,68,.04) 100%);border:1px solid #e8c5c0;border-radius:8px;padding:var(--space-10) var(--space-12);margin-top:var(--space-12);line-height:1.5}
.cmp-hint{font-size:var(--font-size-caption);color:var(--mut);background:linear-gradient(135deg,var(--accbg) 0%,rgba(83,74,183,.03) 100%);border:1px solid rgba(83,74,183,.12);border-radius:8px;padding:var(--space-10) var(--space-12);margin-top:var(--space-12);line-height:1.5}
