...
.ss-paste{flex:1;min-width:0;font:var(--font-weight-medium) 11px ui-monospace,Menlo,monospace;color:var(--ink);background:var(--ss-btn-bg);border:1px solid var(--bd);border-radius:8px;padding:var(--space-9) var(--space-10);resize:none;line-height:1.45}
...
.tr-spark{flex:1;min-width:0;font:var(--font-weight-semibold) 18px ui-monospace,Menlo,monospace;letter-spacing:1px;line-height:1;white-space:nowrap;overflow:hidden;text-shadow:0 0 8px rgba(83,74,183,.15)}
