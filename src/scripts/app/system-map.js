...
.stg .ln{position:absolute;left:var(--space-14);top:var(--space-30);bottom:-2px;width:var(--space-2);background:linear-gradient(180deg,var(--sm-line) 0%,var(--acc-a15) 50%,var(--sm-line) 100%);border-radius:1px}
...
.stg:hover .dot{transform:scale(1.08);box-shadow:0 0 0 4px var(--acc-a08)}
