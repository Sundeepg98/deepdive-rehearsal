...
.stg.cur .nm{color:var(--accink);font-weight:700;text-shadow:0 0 8px rgba(83,74,183,.08)}
...
.piv .pa b{color:var(--accink);font-weight:700;text-shadow:0 0 6px rgba(83,74,183,.06)}
