...
(function () {
  ...
  function hint(dir) {
    if (!hintEl) {
      ...
      hintEl.style.cssText = 'position:fixed;top:50%;transform:translateY(-50%);font-size:var(--font-size-display);line-height:var(--line-height-none);color:var(--acc);opacity:0;transition:opacity var(--duration-base) var(--ease-base);pointer-events:none;z-index:var(--z-tooltip);padding:var(--space-8) var(--space-13);background:var(--card);border:1px solid var(--bd);border-radius:50%;box-shadow:0 4px 16px var(--acc-a18)';
