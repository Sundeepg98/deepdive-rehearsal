...
.dots i.on{background:var(--dots-on-bg);transform:scale(1.35);box-shadow:0 0 0 3px var(--acc-a12),0 0 12px 2px var(--acc-a18);animation:dotPulse 2s ease-in-out infinite}
@keyframes dotPulse{0%,100%{box-shadow:0 0 0 3px var(--acc-a12),0 0 12px 2px var(--acc-a18)}50%{box-shadow:0 0 0 5px var(--acc-a20),0 0 20px 4px var(--acc-a30)}}
...
.ins{margin-top:var(--space-14);font-size:var(--font-size-caption);color:var(--ins-fg);background:linear-gradient(135deg,var(--ins-bg) 0%,var(--acc-a03) 100%);border-left:3px solid var(--acc);border-radius:9px;padding:var(--space-13) var(--space-16);line-height:var(--line-height-spacious);box-shadow:0 1px 4px -2px var(--acc-a08);animation:insIn var(--duration-slow) var(--ease-base) var(--duration-instant) backwards}
