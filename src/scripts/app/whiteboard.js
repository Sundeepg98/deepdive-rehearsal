...
.dgm-s{font-size:10.5px;color:var(--mut);margin-top:var(--space-2);line-height:1.4}
...
.dgm-lbl{font-size:10px;color:var(--mut2);margin-top:var(--space-1);text-align:center;max-width:var(--space-270)}
...
.dgm-note,.dgm-foot{font-size:10px;color:var(--mut);text-align:center;max-width:var(--space-290);margin-top:var(--space-6);line-height:1.45}
...
.wb-count{font-family:var(--mono);font-size:11px;font-weight:800;color:var(--acc);letter-spacing:.3px;margin-bottom:var(--space-14)}
.wb{list-style:none;counter-reset:wb}
.wb li{counter-increment:wb;display:block;padding:var(--space-15) 0;border-bottom:1px solid var(--wb-li-bd);transition:padding .2s ease}
...
.wb li .num{flex:none;width:var(--space-30);height:var(--space-30);border-radius:50%;border:2px solid var(--acc);color:var(--acc);font:700 13px ui-monospace,monospace;display:flex;align-items:center;justify-content:center;transition:transform .3s cubic-bezier(.34,1.56,.64,1),box-shadow .3s ease,background .25s ease;background:linear-gradient(135deg,transparent 0%,rgba(83,74,183,.04) 100%)}
...
.wb-ct{font-size:13.5px;color:var(--ink);font-weight:600;padding-top:var(--space-4);line-height:1.5;transition:color .2s ease}
.wb li:hover .wb-ct{color:var(--accink)}
.wb-ans{display:none;margin:var(--space-10) 0 0 var(--space-42);padding:var(--space-12) var(--space-15);background:linear-gradient(135deg,var(--accbg) 0%,rgba(83,74,183,.04) 100%);border-radius:9px;font-size:12.7px;color:var(--ink);line-height:1.56;box-shadow:0 1px 4px -2px rgba(83,74,183,.06)}
...
.wb-rev,.wb-got,.wb-miss{font:700 11.5px -apple-system,sans-serif;padding:var(--space-7) var(--space-14);border-radius:8px;border:1px solid var(--bd);background:var(--card);color:var(--mut);cursor:pointer;transition:transform .15s ease,box-shadow .2s ease,border-color .15s ease,background .15s ease}
...
.wb-verdict{display:none;margin-top:var(--space-18);padding:var(--space-14) var(--space-17);border-radius:11px;font-size:12.7px;line-height:1.55}
...
.wb-verdict.ok::before{content:"\\2714";margin-right:var(--space-6);font-size:14px}
.wb-verdict.ok b{color:var(--wb-ok-b-fg)}
#wbrerun{display:block;margin-top:var(--space-12);font:700 12px -apple-system,sans-serif;padding:var(--space-8) var(--space-16);border-radius:8px;border:1.5px solid var(--amber);background:linear-gradient(135deg,#fff 0%,var(--amberbg) 100%);color:var(--amber);cursor:pointer;transition:transform .15s ease,box-shadow .2s ease}
...
.wb-foot{margin-top:var(--space-18);font-size:12px;color:var(--wb-foot-fg);background:linear-gradient(135deg,var(--wb-foot-bg) 0%,rgba(83,74,183,.03) 100%);border-left:3px solid var(--acc);border-radius:9px;padding:var(--space-13) var(--space-16);line-height:1.6}
...
.wb-verdict.warn::before{content:"\\26A0";margin-right:var(--space-6);font-size:14px}
