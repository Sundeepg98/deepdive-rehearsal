...
function (vals, fmt) {
  ...
  return [
    ...
    { k: 'Load the flag service sees', v: refresh > 0 ? fmt.n(inst * 60 / refresh) : 'n/a', u: 'polls/min', n: 'the FLEET refreshing its ruleset \u2014 driven by instance count and refresh interval, never by traffic. Compare it with the evaluation rate above: that gap is the whole trick', over: false },
