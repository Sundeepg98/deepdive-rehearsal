...
Lead with write amplification, not the write rate. 10 MB/s of logical writes becomes ~400 MB/s of physical writes in either engine --- the question is whether they land sequentially or randomly, and whether compaction has headroom.
