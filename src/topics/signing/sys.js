...
var TOPIC_SIGN_SYS = {
  ...
  pivots: [
    { q: "The bytes I&rsquo;m signing &mdash; where do they come from?", chip: "\u2192 Content pipeline (1)",
    ...
    { q: "Whose key signs this &mdash; and how is one tenant&rsquo;s key kept off another&rsquo;s packages?", chip: "\u2192 Authz / keys (3)",
    ...
    { q: "The private key lives in an HSM &mdash; how is that infrastructure locked down?", chip: "\u2192 AWS hardening (4)",
    ...
    { q: "The device got a signed package &mdash; how does it know it&rsquo;s the one it&rsquo;s supposed to run?", chip: "\u2192 Desired-state (7)",
    ...
    { q: "The HSM, the keys, the signing role &mdash; how is all that defined repeatably?", chip: "\u2192 IaC (8)",
