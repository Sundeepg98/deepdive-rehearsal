 ...
 * COVERS   17 baselines: home + walk/drill/sys/num/wb panes, light+dark, desktop 1280x800; the
 *          accent rebind across ALL SIX rooms (walk, light); and mobile 390x844 (walk light+dark,
 *          and the HOME -- a layout path that shares almost nothing with its desktop twin).
